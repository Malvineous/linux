 ...
 *
 * Platform devices common to all NUC700 variants.
 *
...
void __init nuc700_board_init(void)
{
	...
	pdev = platform_device_register_resndata(NULL, "nuc700-ohci", -1,
		nuc700_ohci_resource, ARRAY_SIZE(nuc700_ohci_resource), NULL,
		0);
	pdev->dev.dma_mask = &nuc700_device_ohci_dmamask;
	pdev->dev.coherent_dma_mask = 0xffffffffUL;

	pdev = platform_device_register_resndata(NULL, "nuc900-emc", -1,
	...
	platform_device_register_resndata(NULL, "nuc900-spi", -1,
	...
	platform_device_register_resndata(NULL, "nuc900-ac97", -1,
		nuc700_audio_resource, ARRAY_SIZE(nuc700_audio_resource), NULL,
		0);
